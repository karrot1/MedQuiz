...
public class resultScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Button[] questionarray = new Button[10];
        ...
        again.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Quiz.getQuizname().equals("ciwaar")) {
                    ...
                    Intent intent = new Intent(resultScreen.this, eightanswerquestion.class);
                    intent.putExtra("quiz", quiz);
                    startActivity(intent);
                }
                else if (Quiz.getQuizname().equals("cows")) {
                    quiz quiz = Quiz.getUtilfunc().createcows();
                    Intent intent = new Intent(resultScreen.this, fouranswerquestion.class);
                    intent.putExtra("quiz", quiz);
                    startActivity(intent);
                }
            }
    ...
    public void updateqs(quiz Quiz){
        if (Quiz.getQuestions()[Quiz.getCurrentq()].getAnswerno() == 8) {
            ...
            Intent intent = new Intent(resultScreen.this, fiveAnswerQuestion.class);
            intent.putExtra("quiz", Quiz);
            startActivity(intent);
        }
    }
